...
import 'package:louishome_web/screens/starter/components/starter_pageController.dart';

import '../../components/constants.dart';

class StarterDogScreen extends StatelessWidget {
  StarterDogScreen({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Positioned(
            ...
            child: _textWithButton(
              ...
              height: 211,
              text: '식품관',
              subText: '성장기 아이들은 잘 먹어야 무럭무럭 자라기 때문에 프로바이오틱스, 식이섬유가 풍부한 사료 필요',
            ),
          ),
          Positioned(
            left: 80,
          ...
          Positioned(left: 700, top: 582, child: _greyBackgroundImage()),
          Positioned(left: 80, top: 1168, child: _greyBackgroundImage()),
      ...
      child: Column(
        ...
        children: [
          ...
          InkWell(
            ...
            onTap: () {
              pagesController.changePage(PageName.STARTER_PRODUCT.index);
            },
          ),
        ],
      ),
